...
def process_puffer(sent_file, acked_file, output_file, group_size=100, max_rows=1000000):
    ...
    print("Sent Column names:")
    print(sent.columns.tolist())

    print("Acked Column names:")
    print(acked.columns.tolist())
    ...
    sent_time = merged["time (ns GMT)_sent"].values    # ns time_sent
    ack_time = merged["time (ns GMT)_acked"].values    # ns time_acked
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 4:
        ...
        # Default values for testing (when run directly without arguments)
        print("Usage: python process_puffer.py <sent_file> <acked_file> <output_file>")
        print("Running with default test files...")

    # process_puffer(
    #     "../../puffer_data_original/video_sent_2025-09-20T11_2025-09-21T11.csv",
    #     "../../puffer_data_original/video_acked_2025-09-20T11_2025-09-21T11.csv",
    #     "../../puffer_data_cleaned/2025-09-20T11_2025-09-21T11_training_data.csv",
    #     group_size=100,
    #     max_rows=10000
    # )
